...
<html>
    ...
    <body>
     <div>
      ...
      String chartHTMLCode=FusionChartsCreator.createChartHTML("/charts/swf/Column3D.swf", "http://localhost:8080/charts/charts/pru2", "", "tsi 3 2010", 600, 300,false);       
      %>
      <%=chartHTMLCode%>
        ...
        <div class="body">
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="usuario.tareas.label" default="Tareas" /></td>
			...
			<td valign="top" class="value ${hasErrors(bean: usuarioInstance, field: 'foto', 'errors')}">
				<input type="image" id="foto" name="foto" />
				<img src="
					<g:createLink controller='Usuario' action='renderImage' id='${userId}'
				"/>
			</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="usuario.homepage.label" default="Homepage" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: usuarioInstance, field: "homepage")}</td>
