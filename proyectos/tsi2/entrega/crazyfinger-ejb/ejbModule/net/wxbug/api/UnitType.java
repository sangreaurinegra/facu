...
public class UnitType implements java.io.Serializable {
    ...
    public static final UnitType English = new UnitType(_English);
    public static final UnitType Metric = new UnitType(_Metric);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://api.wxbug.net/", "UnitType"));
    }
    /**
