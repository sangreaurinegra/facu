...
//		log (" cantidadDeMensajes " + mensajesPendientes.cantidadDeMensajes());
	...
	public void actualizarChat(long idUsuarioOrigen,long idUsuarioDestino) {
		...
		this.usuarioDestino = usuarioList.getUsuarioPorIdUsuario(idUsuarioDestino);
		this.usuario = usuarioList.getUsuarioPorIdUsuario(idUsuarioOrigen);
...
//		return MensajesPendientes.getInstance().consumirMensajesDe(idUsuarioDestino);
		List<String> msgs  = chatBean.getMensajesPendientes().consumirMensajesDe(idUsuarioDestino);
		List<String> ret = new ArrayList<String>();
		for (String m : msgs) {
			ret.add("[" + usuarioDestino.getNombre() + "] " + m);
		}
		return ret;
	}
...
//	}
	...
	public void enviarMensaje() throws JMSException, NamingException {
		...
		mensajesRecibidos.add("[" + usuario.getNombre() + "] " + txt);
