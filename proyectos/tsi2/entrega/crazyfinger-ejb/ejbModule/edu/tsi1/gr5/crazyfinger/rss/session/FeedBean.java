...
//			System.out.println(" feedbean cantidad de noticias " + c.getItems().size());
	...
	public void recargar(String link) {
		System.out.println(" en recargar " + link);
		this.link = link;
		this.noticias.clear();
		cargar();
	}
	...
	private String getURLAplicacion() {
		...
		String res  = "http://" + dominio + ":" + puerto + ""+aplicacion;
		return res;
	}
	
	private String getUrlRSSPorDefecto() { //http://localhost:8080//crazyfinger/rss
		return getURLAplicacion() + "/rss.seam";
	}
	
	public String getUrlNoticias() { //http://localhost:8080//crazyfinger/rss
		return getURLAplicacion() + "/rssnoticias.seam";
	}

	public String getUrlPaquetes() { //http://localhost:8080//crazyfinger/rss
		return getURLAplicacion() + "/rsspaquetes.seam";
	}
