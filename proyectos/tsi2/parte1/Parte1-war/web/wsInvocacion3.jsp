<%-- 
    Document   : wsInvocacion3
    Created on : 05-sep-2009, 13:41:59
    Author     : Maxi
--%>
...
<html>
    ...
    try {
         int arg0 = Integer.parseInt(request.getParameter("a"));
	int arg1 = Integer.parseInt(request.getParameter("b"));
	...
	out.println("Result = "+result);
        ...
        parte1Stateful.setInvocacion("sumaMultiplicacion");
    } catch (Exception ex) {
