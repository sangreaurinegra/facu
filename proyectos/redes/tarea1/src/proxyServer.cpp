...
#define PUERTO_DEFECTO_ADMIN 6543
...
string salidaInicio = "Inicio proxyServer en "+IP_SERVIDOR;
salidaInicio = salidaInicio + intToStr(PUERTO_DEFECTO_CLIENTE);
log( salidaInicio ,LOGGER_INFO);
...
//log("Fin proxyServer",LOGGER_INFO);// si bien no es necesario llegar aca puede estar bueno dar soporte de apagado por consola , que de de baja etc antes de finalizar
