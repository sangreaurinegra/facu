...
#define TIMEOUT			7000000		/* Mascara para deteccion de FIN (se termino usando como timer del select)*/
#define GBN_WINDOW		25//5//25		/* Mascara para deteccion de FIN */

#define MAX_PCT_DATA_SIZE	256		/* contenido maximo de datos en segmento PCT */

#define TAM_BUFFER 10240

#define finTimeOut 5000000 //8 segundos en microsegundos
#define kalTimeOut 40000000 //30 segundos en microsegundos (igual al timer gbn)
#define cantIntentosFin 3
