...
public class MainScreenForm extends Form {
    ...
    private TrucoMIDlet parent;
    private boolean dragMode;

    
    public MainScreenForm(TrucoMIDlet parent, String title) {
        setTitle(title);
        this.parent = parent;
    }
    ...
    public void pointerDragged(int x, int y) {
        ...
        if (draggedImage == null) {
            ...
            cmpTransition = TrucoMIDlet.getComponentTransition();
            TrucoMIDlet.setComponentTransition(null);
            return;
        }
    ...
    private void finishDrag() {
        ...
        draggedImage = null;
        TrucoMIDlet.setComponentTransition(cmpTransition);
        repaint();
    }
