...
import static edu.tsi1.gr5.crazyfinger.helper.ProyectoViajeHelper.htmlPronosticosNoDisponibles;
import static edu.tsi1.gr5.crazyfinger.helper.ProyectoViajeHelper.toTablaPronosticos;
import static edu.tsi1.gr5.crazyfinger.pronosticos.PronosticoHelper.MDB_PROPERTY_FECHA;
import static edu.tsi1.gr5.crazyfinger.pronosticos.PronosticoHelper.MDB_PROPERTY_LATITUD;
import static edu.tsi1.gr5.crazyfinger.pronosticos.PronosticoHelper.MDB_PROPERTY_LONGITUD;
import static edu.tsi1.gr5.crazyfinger.pronosticos.PronosticoHelper.date2string;
import static edu.tsi1.gr5.crazyfinger.pronosticos.PronosticoHelper.dejarSoloDia;
import static edu.tsi1.gr5.crazyfinger.pronosticos.PronosticoHelper.mismoDia;
...
public class PaqueteTuristicoEditBean {
    ...
    List<Nodopt> nodosOrdenados;
    
    long idProyecto = -1;
    
    Paqueteturistico proyecto;
 ...
 // Para enviar a cola pedido de pronosticos.
    ...
    public void init(){
    	...
    	if(idProyecto > 0){
	    	...
	    	proyecto = paqueteturisticoHome.getInstance();
    	}
    }

	public Paqueteturistico getProyecto() {
		return proyecto;
	}

	public void setProyecto(Paqueteturistico proyecto) {
		this.proyecto = proyecto;
	}
    
    
    public List<Nodopt> getNodosOrdenados() {
    	if(nodosOrdenados == null)
    		nodosOrdenados = new ArrayList<Nodopt>(nodoptList.nodosOrdenados(idProyecto));
		return nodosOrdenados;
	}

	public void setNodosOrdenados(List<Nodopt> nodosOrdenados) {
	...
	public void quitarNodo(long idNodo){
    	...
    	Events.instance().raiseEvent("Paqueteturistico.ReloadProyecto");
    }
    
    @Observer("Paqueteturistico.ReloadProyecto")
    ...
    public String verItinerario(){
    	return "/itinerariopt.xhtml?proyecto="+idProyecto;
    }
	...
	public Lugar getCiudadCentrar() {
		...
		if (this.proyecto.getNodopts().size()>0) {
...
//			System.out.println("lon " + ciudad.get(0).getLongitud());
			for (Nodopt n : this.proyecto.getNodopts() ) {
				return n.getLugar();
			}
			return null;
		}
