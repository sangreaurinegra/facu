...
public class ItinerarioBean //implements Itinerario
{
	...
	@Observer("proyectoViaje.CargarSalida")
	...
	public void salvarTramo(){
		...
		Nodopv aux =  nodopvHome.createInstance();
		
		aux.setLugar(ciudad.get(0));
		aux.setTipoNodo(Nodo.TIPO_NODO_PV);
		aux.setOrden(nodopvList.getMaxOrden(idProyecto)+1);
		aux.setProyectoviaje(proyectoviajeHome.getDefinedInstance());
